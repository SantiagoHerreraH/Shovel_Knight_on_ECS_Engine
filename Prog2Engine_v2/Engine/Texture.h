...
public:
	...
	void Draw(const Point2f& locationBottomLeftInScreenPosition = {}, const Rectf& rectangleViewForSpriteSheet = {}) const;
	void Draw( const Rectf& locationAndScaleOfTextureInScreen, const Rectf& rectangleViewForSpriteSheet = {} ) const;
